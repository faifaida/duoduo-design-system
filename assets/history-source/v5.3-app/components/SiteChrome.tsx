...
const interfaceTranslations: Record<Locale, Record<string, string>> = {
  original: { home: "主页", stories: "故事", work: "作品", about: "关于", surf: "冲浪", ai: "问多多", subtitle: "多多的未完成实验" },
  ko: { home: "홈", stories: "이야기", work: "작업", about: "소개", surf: "서핑", ai: "두오두오에게 묻기", subtitle: "두오두오의 미완성 실험" },
  ja: { home: "ホーム", stories: "物語", work: "作品", about: "紹介", surf: "サーフィン", ai: "多多に聞く", subtitle: "多多の未完成な実験" },
  es: { home: "Inicio", stories: "Historias", work: "Obras", about: "Sobre mí", surf: "Surf", ai: "Pregunta", subtitle: "Los experimentos inacabados de Duoduo" },
  fr: { home: "Accueil", stories: "Récits", work: "Projets", about: "À propos", surf: "Surf", ai: "Demander", subtitle: "Les expériences inachevées de Duoduo" },
};
    ...
    <>
      <header className="site-chrome">
        ...
        <div className="chrome-tools">
          ...
          {current !== "ai" && (
            <a className="chrome-ai-link" href="/ai" aria-label="Ask DUODUO AI">
              <span>AI</span><small>问多多</small>
            </a>
          )}
          <ClickSound />
